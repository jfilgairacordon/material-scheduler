...
export class AppComponent
{
    ...
    shifts = [
        {
            title: "Evento 1",
            dateIni: new Date(2019, 11, 15, 9, 10),
            dateEnd: new Date(2019, 11, 15, 22, 0),
            id: 1
        },
        {
            title: "Evento 2",
            dateIni: new Date(2019, 11, 15, 10, 10),
            dateEnd: new Date(2019, 11, 15, 22, 0),
            id: 2
        },
        {
            title: "Andale Rigoberto",
            dateIni: new Date(2019, 11, 20, 9, 0),
            dateEnd: new Date(2019, 11, 20, 15, 0),
            id: 3
        },
        {
            title: "Lectura",
            dateIni: new Date(2019, 11, 11, 10, 10),
            dateEnd: new Date(2019, 11, 11, 11, 0),
            cssClass: 'red',
            id: 4
        }
